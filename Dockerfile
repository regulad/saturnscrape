...
LABEL name="saturnscrape"
LABEL version="2.0.0"
LABEL vendor="Parker Wahle"
LABEL org.opencontainers.image.title="saturnscrape"
LABEL org.opencontainers.image.version="2.0.0"
LABEL org.opencontainers.image.url="https://github.com/regulad/saturnscrape"
LABEL org.opencontainers.image.documentation="https://saturnscrape.readthedocs.io"
...
COPY --from=builder /code/dist/saturnscrape-*.whl /tmp/
RUN pip install --user /tmp/saturnscrape-*.whl

# Now do something!
CMD ["/home/saturnscrape/.local/bin/saturnscrape"]
